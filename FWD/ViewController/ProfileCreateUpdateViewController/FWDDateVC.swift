...
class FWDDateVC: UIViewController {
    ...
    var arrFWDDateText = ["Don't know yet" , "Marriage" , "Relationship" , "Something casual"]
    ...
    func setTblViewCell(){
        self.constHeightTblView.constant = CGFloat(arrFWDDateText.count * 64)
    }
...
extension FWDDateVC: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        displayDataCell.viewTxtFooter.textField.text = arrFWDDateText[indexPath.row]
...
extension FWDDateVC: UITableViewDelegate{
