...
class ReligionVC: UIViewController {
    ...
    var arrReligionText = ["Buddhist" , "Christian" , "Hindu" , "Jain" , "Jewish" , "Muslim" ,"Parsi" , "Shikh" , "Spiritual" , "Other"]
    ...
    func setTblViewCell(){
        self.constHeightTblView.constant = CGFloat(arrReligionText.count * 64)
    }
...
extension ReligionVC: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        displayDataCell.viewTxtFooter.textField.text = arrReligionText[indexPath.row]
...
extension ReligionVC: UITableViewDelegate{
